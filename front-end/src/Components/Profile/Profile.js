...
import { getUser, getUserActivities } from '../../Redux/Actions/userActions'
...
class Profile extends Component {
  componentDidMount() {
    ...
    this.props.getUserActivities(this.props.match.params.username)
  }
  render() {
    ...
    return (
      <div style={{height:'100vh',textAlign:'center',display: 'flex', flexDirection: 'column'}}>
        ...
        <div style={{flexGrow: 1,overflow:'scroll',textAlign:'center'}}>
          <div style={{maxWidth:'750px',display:'inline-block',flexGrow: 1}}>
          <Grid
            container
            spacing={24}
            direction="row"
...
export default connect(mapStateToProps, { getUser, getUserActivities })(withStyles(styles)(Profile))
